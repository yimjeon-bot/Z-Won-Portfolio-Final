  ...
  return (
    <div className="min-h-screen bg-brand-paper text-brand-ink font-sans selection:bg-brand-accent/30">
      ...
      <nav className="fixed top-0 w-full bg-brand-paper/80 backdrop-blur-md z-50">
        <div className="max-w-7xl mx-auto px-6 md:px-12 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-12 text-sm font-medium uppercase tracking-widest">
            ...
            <a href="#experience" className="hover:text-blue-800 hover:font-bold transition-all">Experience</a>
            <a href="#education" className="hover:text-blue-800 hover:font-bold transition-all">Education</a>
            <a href="#life" className="hover:text-blue-800 hover:font-bold transition-all">Life</a>
            <a href="#contact" className="hover:text-blue-800 hover:font-bold transition-all">Contact</a>
          </div>
        </div>
      </nav>
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section id="hero" className="h-[calc(100vh-80px)] bg-brand-paper flex items-center px-6 md:px-12">
          <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif mb-6 leading-[1.1] tracking-tight">
                Hi, I'm <br />
                <span className="text-blue-800">Z-won Yim</span>
              </h1>
              <div className="text-lg md:text-xl opacity-80 mb-8 max-w-lg leading-relaxed space-y-2">
            ...
            >
              <div className="max-h-[70vh] w-full aspect-[4/5] overflow-hidden rounded-[4rem] md:rounded-[6rem] shadow-2xl cursor-pointer group relative">
                <img 
                  src="/profile.jpg" 
                  alt="Z-won Yim" 
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-32">
          ...
          <section id="experience" className="mb-48 scroll-mt-32">
            <h2 className="text-4xl font-serif mb-16 text-blue-800">💼 Experience</h2>

            <div className="space-y-24">
              {/* Product Manager */}
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-0 group">
                <div className="md:col-span-3">
                  <span className="text-base font-mono opacity-80 font-medium uppercase tracking-[0.1em] pt-1 block">
                    Jan 2023 — Jun 2025
                  </span>
                  <p className="text-xs font-mono opacity-40 uppercase tracking-widest mt-1">Seoul, Korea</p>
                </div>
                <div className="md:col-span-9">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-3xl font-serif font-bold mb-1">Product Manager</h3>
                      <p className="text-xl italic opacity-60 font-serif mb-2">Hana Bank</p>
                    </div>
                    <button 
                      onClick={() => toggleExp('pm')}
                      className="text-sm font-bold uppercase tracking-widest text-blue-800 hover:opacity-70 transition-opacity mt-2 flex items-center gap-2 whitespace-nowrap flex-shrink-0"
                    >
                      {expandedExp === 'pm' ? 'Close' : 'View Details'}
                      <motion.span animate={{ rotate: expandedExp === 'pm' ? 180 : 0 }}>↓</motion.span>
                    </button>
                  </div>
                  
                  <p className="text-lg opacity-80 max-w-2xl leading-relaxed mb-6">
                    Led internal platform transformations and AI-enabled product initiatives to improve operational efficiency.
                  </p>
                  ...
                  <AnimatePresence>
                    {expandedExp === 'pm' && (
                      ...
                      >
                        <div className="pt-8 pb-4 border-t border-brand-ink/10 mt-4 space-y-6">
                          <div className="space-y-4">
                            <h4 className="text-xs font-mono uppercase tracking-[0.2em] opacity-40">Key Contributions</h4>
                            <ul className="space-y-4">
                              {[
                                ...
                                <li key={i} className="flex gap-3 text-base opacity-80 leading-relaxed">
                                  <span className="text-blue-800 flex-shrink-0 mt-1.5">•</span>
                                  <span>{item}</span>
                                </li>
                              ))}
                            </ul>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-0 group">
                ...
                <div className="md:col-span-9">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-3xl font-serif font-bold mb-1">Program Manager</h3>
                      <p className="text-xl italic opacity-60 font-serif mb-2">Hana Bank</p>
                    </div>
                    <button 
                      onClick={() => toggleExp('pgm')}
                      className="text-sm font-bold uppercase tracking-widest text-blue-800 hover:opacity-70 transition-opacity mt-2 flex items-center gap-2 whitespace-nowrap flex-shrink-0"
                    >
                      {expandedExp === 'pgm' ? 'Close' : 'View Details'}
                      <motion.span animate={{ rotate: expandedExp === 'pgm' ? 180 : 0 }}>↓</motion.span>
                    </button>
                  </div>
                  
                  <p className="text-lg opacity-80 max-w-2xl leading-relaxed mb-6">
                    Directed large-scale compliance system rebuilds and optimized CRM workflows through data-driven insights.
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-0 group">
                <div className="md:col-span-3">
                  ...
                  <p className="text-xs font-mono opacity-40 uppercase tracking-widest mt-1">Daejeon, Korea</p>
                </div>
                <div className="md:col-span-9">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-3xl font-serif font-bold mb-1">IT Leadership Development Program</h3>
                      <p className="text-xl italic opacity-60 font-serif mb-2">KAIST x Hana Bank</p>
                    </div>
                    <button 
                      onClick={() => toggleExp('ldp')}
                      className="text-sm font-bold uppercase tracking-widest text-blue-800 hover:opacity-70 transition-opacity mt-2 flex items-center gap-2 whitespace-nowrap flex-shrink-0"
                    >
                      {expandedExp === 'ldp' ? 'Close' : 'View Details'}
                      <motion.span animate={{ rotate: expandedExp === 'ldp' ? 180 : 0 }}>↓</motion.span>
                    </button>
                  </div>
                  
                  <p className="text-lg opacity-80 max-w-2xl leading-relaxed mb-6">
                    Company-sponsored, full-time six-month advanced IT training at KAIST, Korea’s top tech university.
                  </p>
                  ...
                  <AnimatePresence>
                    {expandedExp === 'ldp' && (
                      ...
                      >
                        <div className="pt-8 pb-4 border-t border-brand-ink/10 mt-4 space-y-6">
                          <div className="space-y-4">
                            <h4 className="text-xs font-mono uppercase tracking-[0.2em] opacity-40">Highlights</h4>
                            <ul className="space-y-4">
                              {[
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-0 group">
                ...
                <div className="md:col-span-9">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-3xl font-serif font-bold mb-1">Customer Experience (CX) Analyst</h3>
                      <p className="text-xl italic opacity-60 font-serif mb-2">Hana Bank</p>
                    </div>
                    <button 
                      onClick={() => toggleExp('cea')}
                      className="text-sm font-bold uppercase tracking-widest text-blue-800 hover:opacity-70 transition-opacity mt-2 flex items-center gap-2 whitespace-nowrap flex-shrink-0"
                    >
                      {expandedExp === 'cea' ? 'Close' : 'View Details'}
                      <motion.span animate={{ rotate: expandedExp === 'cea' ? 180 : 0 }}>↓</motion.span>
                    </button>
                  </div>
                  
                  <p className="text-lg opacity-80 max-w-2xl leading-relaxed mb-6">
                    Translated frontline customer insights into prioritized problem statements and redesigned branch workflows.
                  </p>
          ...
          <section id="education" className="mb-48 scroll-mt-32">
            <h2 className="text-4xl font-serif mb-16 text-blue-800">🎓 Education</h2>
            <div className="space-y-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-0">
                ...
                <div className="md:col-span-9">
                  <h3 className="text-2xl font-serif font-bold mb-2">Master of Business Administration</h3>
                  <p className="text-xl italic opacity-60 font-serif mb-4">Duke University, The Fuqua School of Business</p>
                  <p className="text-sm opacity-40 leading-relaxed max-w-2xl">
                    Forte Foundation Fellow | Merit Scholarship Recipient | Cabinet, Tech Club & Asian Business Club
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-0">
                ...
                <div className="md:col-span-9">
                  <h3 className="text-2xl font-serif font-bold mb-2">Bachelor of Information Systems</h3>
                  <p className="text-xl italic opacity-60 font-serif mb-4">Kookmin University, School of Business</p>
                  <p className="text-sm opacity-40 leading-relaxed max-w-2xl">
                    Honors: Award for Excellence, IT Project & Idea Award | VP, Media Arts Club
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="life" className="mb-24 scroll-mt-32">
            <div className="px-6 md:px-0 flex items-end justify-between mb-12">
              <div>
                <h2 className="text-4xl font-serif text-blue-800">✨ Beyond the Desk</h2>
              </div>
            ...
            <div className="relative group/gallery">
              <div 
                ref={scrollRef}
                className="flex overflow-x-auto pb-8 gap-6 no-scrollbar snap-x snap-mandatory px-6 md:px-0"
              >
                {lifePosts.map((post) => (
                  <motion.div
                    key={post.id}
                    className="flex-none w-[180px] sm:w-[220px] md:w-[260px] cursor-pointer snap-start"
                    onClick={() => setSelectedLifePost(post)}
                  >
                    <div className="aspect-square overflow-hidden rounded-[1.5rem] bg-brand-ink/5 shadow-sm border border-brand-ink/5 relative group">
                      <motion.img
                        src={post.image}
                        alt={post.title}
                        whileHover={{ x: -20, scale: 1.1 }}
                        transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
                        className="w-[120%] h-full max-w-none object-cover transition-all duration-700"
                        referrerPolicy="no-referrer"
                        onError={(e) => {
                    ...
                    <div className="mt-3 px-1">
                      <h3 className="text-base font-serif font-medium opacity-80 truncate">{post.title}</h3>
          ...
          <section id="contact" className="scroll-mt-32">
            <div className="text-center pt-20 pb-12 border-t border-brand-ink/10">
              <h2 className="text-4xl md:text-5xl font-serif mb-8 text-blue-800">Let's connect!</h2>
              <div className="flex justify-center gap-8">
                <a 
                  href="mailto:zwon.yim@duke.edu" 
                  className="w-14 h-14 flex items-center justify-center bg-blue-800 text-white rounded-full hover:scale-110 transition-all shadow-md"
                  title="Email me"
                >
                  <Mail size={24} />
                </a>
      ...
      <footer className="py-12 px-6 md:px-12 border-t border-brand-ink/5 text-center">
        ...
        {selectedLifePost && (
          ...
          >
            ...
            >
              <button 
                onClick={() => setSelectedLifePost(null)}
                className="absolute top-6 right-6 z-10 p-3 bg-black/10 hover:bg-black/20 rounded-full transition-colors"
              >
                <X size={24} />
              </button>
              ...
              <div className="w-full md:w-1/2 p-8 md:p-12 overflow-y-auto">
                <div className="max-w-md mx-auto">
                  <p className="text-sm font-bold uppercase tracking-[0.2em] text-blue-800 mb-4">
                    {selectedLifePost.date}
                  </p>
                  <h2 className="text-4xl md:text-5xl font-serif mb-8 leading-tight">
                    {selectedLifePost.title}
                  </h2>
                  <div className="prose prose-lg text-brand-ink/80 leading-relaxed italic font-serif">
        ...
        {isImageExpanded && (
          ...
          >
            ...
            >
              <button 
                onClick={() => setIsImageExpanded(false)}
                className="absolute -top-12 right-0 md:-right-12 text-brand-ink hover:opacity-60 transition-opacity p-2"
              >
                <X size={32} />
              </button>
              <img 
